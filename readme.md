...
Users can create an account to add, view, edit, and delete their own decks. They can use filters to search the YGO card database and build their decks. Users can also view popular decks on the homepage.

### Deck Edit Page
<img src="/static/images/deck-edit-page.png" height="500" alt="deck-edit"/>

### Homepage
<img src="/static/images/homepage.png" height="500" alt="homepage"/>

### User Decks Page
<img src="/static/images/user-decks.png" height="500" alt="user-decks"/>
